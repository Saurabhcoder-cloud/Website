import { ShieldCheck, KeyRound, Lock, ServerCog, Users } from 'lucide-react';
...
const controls = [
  {
    ...
    description: 'TLS 1.3 enforced in transit, AES-256 encryption at rest with per-tenant keys managed via AWS KMS.',
  },
  {
    icon: ServerCog,
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'SOC2 Type II report, penetration testing summaries, Lighthouse audits, and quarterly compliance dashboards for enterprise customers.',
  },
];

export default function SecurityPage() {
  usePageMetadata({
    title: 'Security & Privacy | TaxHelp AI',
    description:
      'Explore TaxHelp AI security: SOC2-ready controls, encryption, retention policies, and consent-aware logging for compliant tax automation.',
      ...
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            Built for regulated teams that need explicit consent tracking, configurable retention, and verifiable controls across
            the entire filing journey.
          </p>
        </div>
        ...
        <section className="mt-16 rounded-3xl border border-primary/30 bg-primary/5 p-10 text-left">
          ...
          <ul className="mt-6 space-y-4 text-sm text-muted-foreground">
            <li>
              <ShieldCheck className="mr-2 inline h-4 w-4 text-primary" aria-hidden /> SOC2 Type II readiness kit delivered
              quarterly with mapped evidence.
            </li>
            <li>
              <ShieldCheck className="mr-2 inline h-4 w-4 text-primary" aria-hidden /> IRS Publication 1345 identity proofing
              workflows baked into onboarding.
            </li>
            <li>
              <ShieldCheck className="mr-2 inline h-4 w-4 text-primary" aria-hidden /> CCPA/CPRA request handling SLA under 7
              days with portal for secure file delivery.
            </li>
          </ul>
        </section>
